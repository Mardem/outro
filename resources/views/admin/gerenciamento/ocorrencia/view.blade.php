                ...
                <div class="col-sm-6 grid-margin strech-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @else
                            <div class="form-group">
                                <label for="socio_cheque_id">Sócio cheque*:</label>
                                <select id="socio_cheque_id" name="socio_cheque_id" class="form-control" required>

                                    <option disabled>Selecionado:</option>
                                    <option value="{{ $ocorrencia->socio_cheque_id }}">{{ $ocorrencia->socioCheque->emitente }}</option>
...
@if(\Auth::user()->category == 2 && $mensagens->total() < 1) @include('layouts.components.tripjs') @endif
    @section('scripts') <script src="{{ asset('js/admin/datepicker/foundation-datepicker.min.js') }}">
    </script>
