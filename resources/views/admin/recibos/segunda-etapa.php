...
<body>
    ...
    <div id="app" class="container mt-2 mb-4">
        ...
        <div id="div-print">
            <div class="row mt-3">
                <div class="col-sm-12">
                    <img src="/img/logo-solucao.svg" width="350" class="float-left no-print" id="logoSol" alt="Logo Solução">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p>
                        ...
                        junto
                        ao
                        <b>ITIQUIRA PARK</b>. Referente ao Rateio de Ampliação Patrimonial (piscina de ondas 2ª ETAPA).
                    </p>
                    ...
                    <p>
                        <b>
                            <u>
                                ...
                                (PISCINA DE ONDAS) E GANHA COMO BONIFICAÇÃO:
                            </u>
                        </b>
                    </p>
            ...
            <div class="row mt-5">
                <div class="col">
                    <p v-if="telephone != ''">TELEFONE: {{ telephone }}</p>
                    <p v-if="address != ''">ENDEREÇO: {{ address }}</p>
                    <p v-if="city != ''">CIDADE: {{ city }}</p>
                    <p v-if="email != ''">EMAIL: {{ email }} </p>
                </div>
                <div class="col">
                    <p v-if="neighborhood != ''">BAIRRO: {{ neighborhood }} </p>
                    <p v-if="zipcode != ''">CEP: {{ zipcode }}</p>
                </div>
            </div>
