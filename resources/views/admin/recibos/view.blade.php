...
<div id="app" class="container mt-2 mb-4">
    ...
    <div id="div-print">
        <div class="row mt-3">
            <div class="col-sm-12">
                <img src="{{ asset('/img/logo-solucao.svg') }}" width="350" class="float-left no-print" id="logoSol"
                    alt="Logo Solução">
                <img src="{{ asset('/img/ItiquiraPark.svg') }}" class="float-right" id="logoIt"
...
@endsection
@section('styles')
<link rel="stylesheet" href="{{ asset('css/contracts.css') }}">
@endsection
