...
<body>
    ...
    <div id="app" class="container mt-2 mb-4">
        <form action="{{ route('receipt.insertLog') }}" method="POST" id="form-insert-log">
            ...
            <input type="hidden" name="type" value="{{ \App\Models\ReceiptLogs::TYPE['SEGUNDA_ETAPA'] }}">
            @csrf
            <div class="row mb-4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p>
                        ...
                        junto
                        ao
                        <b>ITIQUIRA PARK</b>. Referente ao Rateio de Ampliação Patrimonial (piscina de ondas 2ª
                        ETAPA).
                    </p>
