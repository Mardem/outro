                    ...
                    <div class="card-body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control pula" id="fone1" value="{{ $socio->fone1 }}"
                                       disabled>
                            </div>

                            <div class="col-md-3">
                                <label for="fone2">Fone 2:</label>
                                <input type="text" class="form-control pula" id="fone2" value="{{ $socio->fone2 }}"
                                       disabled>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control pula" id="fone3" value="{{ $socio->fone3 }}"
                                       disabled>
                            </div>
