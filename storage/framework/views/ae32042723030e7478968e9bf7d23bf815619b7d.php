...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Acesso ao Sistema Solução'); ?></title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo e(asset('css/login-style.min.css')); ?>">
        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <p><?php echo $__env->yieldContent('subdescription', 'Faça o seu login para acessar a parte interna do sistema'); ?></p>
                    <div class="page-links">
                        <?php echo $__env->yieldContent('pageLinks'); ?>
                    </div>
