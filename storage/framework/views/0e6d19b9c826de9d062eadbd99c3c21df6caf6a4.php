                ...
                <div class="card-body">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control pula" id="fone1" value="<?php echo e($socio->fone1); ?>" disabled>
                        </div>

                        <div class="col-md-3">
                            <label for="fone2">Fone 2:</label>
                            <input type="text" class="form-control pula" id="fone2" value="<?php echo e($socio->fone2); ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control pula" id="fone3" value="<?php echo e($socio->fone3); ?>" disabled>
                        </div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $ocorrencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ocorrencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('ocorrencia.show', ['id' => $ocorrencia->id])); ?>" class="btn btn-outline-primary">Ver</a>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
